...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<frameset rows="94,*,23" frameborder="no" border="0" framespacing="0" id="top">
	  ...
	  <frameset cols="189,7,*" frameborder="no" border="0" framespacing="0" id="frams">
		...
		<frame src="admin.php" id="mainFrame" name="mainFrame" title="mainFrame" />
	  </frameset>
