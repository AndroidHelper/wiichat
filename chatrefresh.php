...
<p><a href='privateChat.php?uid=<?php echo $uid?>&amp;r=<?php echo rand();?>&amp;refresh=2'>[设置为手动刷新]</a></p>
<div id="ni"></div>
...
function check(){
	...
	for(var i = 0;i < allRadio.length;i++){
	   if(allRadio[i].checked){
		location.href='privateChat.php?uid=<?php echo $uid?>&r=<?php echo rand();?>&refresh=1&refreshvalue='+allRadio[i].value;
		}
	}
}
</script>